...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.29; // in; distance between the left and right wheels
    ...
    public static double X_MULTIPLIER = 1.03; // Multiplier in the X direction
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        leftEncoder.setDirection(Encoder.Direction.REVERSE); // add if needed
